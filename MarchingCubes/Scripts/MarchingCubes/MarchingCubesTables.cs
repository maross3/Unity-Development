...
{
    // Edge table lists the edges intersected by the surface for each cube configuration.
    // The index corresponds to the cube index, and the inner array contains the edge indices.
